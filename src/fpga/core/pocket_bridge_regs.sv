...
// It intentionally stays small: stable control/status registers plus loader
// bookkeeping that the Pocket-specific adapters consume elsewhere.
...
always @(posedge clk or negedge reset_n) begin
    if (!reset_n) begin
        ...
        snapshot_save_request_toggle <= 1'b0;
        ...
        end else if (reg_addr == 16'h003c) begin
