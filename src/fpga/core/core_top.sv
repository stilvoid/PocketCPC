...
//
// This top-level owns the Pocket-facing bridge, clocks, media loaders, video,
// audio, and the imported CPC machine wrapper.
//
...
wire        cpc_snapshot_word_wr = 1'b0;
wire [15:0] cpc_snapshot_word_addr = 16'd0;
wire [15:0] cpc_snapshot_word_data = 16'd0;
wire        cpc_snapshot_save_freeze_cpu;
wire        cpc_snapshot_save_ram_rd;
wire [15:0] cpc_snapshot_save_ram_word_addr;
wire [15:0] cpc_capture_ram_word_data;
...
wire [7:0]  cpc_state_ppi_b;
wire [7:0]  cpc_state_ppi_c;
...
cpc_machine_pocket cpc_machine (
    ...
    .snapshot_busy_reset ( cpc_restore_busy_reset ),
    .snapshot_mem_wr ( cpc_restore_snapshot_mem_wr ),
    .snapshot_mem_addr ( cpc_restore_snapshot_mem_addr ),
    .snapshot_mem_data ( cpc_restore_snapshot_mem_data ),
    .snapshot_word_wr ( cpc_restore_snapshot_word_wr ),
    .snapshot_word_addr ( cpc_restore_snapshot_word_addr ),
    .snapshot_word_data ( cpc_restore_snapshot_word_data ),
    .sna_load        ( cpc_restore_sna_load ),
    ...
    .sna_ppi_b       ( cpc_restore_sna_ppi_b ),
    .sna_ppi_c       ( cpc_restore_sna_ppi_c ),
    .sna_ppi_control ( cpc_restore_sna_ppi_control ),
    .sna_psg_addr    ( cpc_restore_sna_psg_addr ),
...
always @(posedge audio_mclk) begin
    if (!cpc_audio_pll_locked) begin
        cpc_audio_l_mclk <= 16'd0;
        cpc_audio_r_mclk <= 16'd0;
    end else if (cpc_audio_sample_mclk_strobe) begin
...
wire        snapshot_save_target_dataslot_write;
wire        snapshot_save_target_dataslot_openfile;
wire [15:0] snapshot_save_target_dataslot_id;
wire [31:0] snapshot_save_target_dataslot_slotoffset;
wire [31:0] snapshot_save_target_dataslot_bridgeaddr;
wire [31:0] snapshot_save_target_dataslot_length;
wire [31:0] snapshot_save_target_buffer_param_struct;
wire        snapshot_save_cmd_request_flag;
wire        snapshot_save_cmd_write_strobe;
wire        snapshot_save_target_active;
...
wire        snapshot_save_bridge_selected;
...
always @(posedge cpc_clk) begin
    if (!cpc_loader_reset_n) begin
        ...
        snapshot_save_request_toggle_cpc_d <= 1'b0;
    end else begin
        ...
        snapshot_save_request_toggle_cpc_d <= snapshot_save_request_toggle_cpc;
    end
end
...
pocket_sna_save_dataslot snapshot_save (
    ...
    .bridge_addr                 ( bridge_addr ),
    .bridge_rd                   ( bridge_rd ),
    .bridge_rd_data              ( snapshot_save_bridge_rd_data ),
    .bridge_selected             ( snapshot_save_bridge_selected ),
    .save_request                ( cpc_snapshot_save_pulse_cpc ),
    .media_busy                  ( cpc_media_activity_raw ),
    .state_model                 ( cpc_state_model ),
    .state_cpu_dir               ( cpc_state_cpu_dir ),
    .state_crtc_addr             ( cpc_state_crtc_addr ),
    .state_crtc_regs             ( cpc_state_crtc_regs ),
    ...
    .rtc_valid                   ( rtc_valid ),
    .freeze_cpu                  ( cpc_snapshot_save_freeze_cpu ),
    .capture_ram_rd              ( cpc_snapshot_save_ram_rd ),
    .capture_ram_word_addr       ( cpc_snapshot_save_ram_word_addr ),
    .capture_ram_word_data       ( cpc_capture_ram_word_data ),
    .target_dataslot_write       ( snapshot_save_target_dataslot_write ),
    .target_dataslot_openfile    ( snapshot_save_target_dataslot_openfile ),
    .target_dataslot_id          ( snapshot_save_target_dataslot_id ),
    .target_dataslot_slotoffset  ( snapshot_save_target_dataslot_slotoffset ),
    .target_dataslot_bridgeaddr  ( snapshot_save_target_dataslot_bridgeaddr ),
    .target_dataslot_length      ( snapshot_save_target_dataslot_length ),
    .target_buffer_param_struct  ( snapshot_save_target_buffer_param_struct ),
    .cmd_request_flag            ( snapshot_save_cmd_request_flag ),
    .cmd_write_strobe            ( snapshot_save_cmd_write_strobe ),
    .cmd_ack_flag                ( snapshot_save_client_selected ? bridge_cmd_ack_flag : 1'b0 ),
    .target_dataslot_ack         ( snapshot_save_client_selected ? target_dataslot_ack_cpc : 1'b0 ),
    .target_dataslot_done        ( snapshot_save_client_selected ? target_dataslot_done_cpc : 1'b0 ),
    .target_dataslot_err         ( snapshot_save_client_selected ? target_dataslot_err_cpc : 3'd0 ),
    .target_active               ( snapshot_save_target_active ),
    .save_busy                   ( cpc_snapshot_save_busy ),
    .save_ok                     ( cpc_snapshot_save_ok ),
...
core_bridge_cmd cmd (
    ...
    .target_buffer_param_struct  ( snapshot_save_client_selected ? snapshot_save_target_buffer_param_struct : 32'd0 ),
