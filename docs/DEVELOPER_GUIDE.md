...
flows should still be treated as early. Snapshot-save HDL exists in the tree,
but it is not exposed in the public APF metadata until the data-slot write path
has been validated on Pocket hardware.
