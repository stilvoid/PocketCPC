...
- Start is currently left unbound
...
`R` cycles between the four VKB pages. The fourth page is a shortcut page with
five built-in command macros: `|TAPE`, `|DISC`, `CAT`, `RUN"`, and
`RUN"DISC`, each emitted with a trailing `Return`.
